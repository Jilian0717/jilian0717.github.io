...
Xiong, J., MacCready, P., Brasseale, E. A., Allan, E. A., Ramon-Laca, A., Parsons, K., Shaffer, M.,
Kelly, P. Ocean transport drives environmental DNA dispersal in a nearshore marine environment
(in revision).
...
Harmful algal blooms (HABs) threaten marine life and human health. To advance predictions of HABs, we developed a new LPT-Biological (LPT-Bio) model that integrates the advantages of both Lagrangian and Eulerian 
<img class="col one last" src="{{ site.baseurl }}/images/publication_preview/LPT_Bio_model.jpg" style="float:right; width: 60%; height: 60%">
